    ...
    <div className="min-h-dvh bg-background flex flex-col">
      ...
      <div className="flex-1 max-w-lg mx-auto w-full px-5">
        ...
        <div className="grid grid-cols-3 gap-3 mb-6">
          {[
            { value: players.length, label: "players", live: true },
            { value: event.roundCount, label: "rounds", live: false },
            { value: event.questionCount, label: "questions", live: false },
          ].map(({ value, label, live }) => (
            <div key={label} className="border border-border rounded-lg p-3 text-center space-y-1">
              <p className={`text-2xl font-bold tabular-nums ${live ? "text-primary" : "text-foreground"}`}>
                {value}
              </p>
          ...
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="flex flex-col gap-2 shrink-0">
              <button
                ...
                className="h-9 px-4 border border-border text-sm font-medium hover:bg-accent transition-colors flex items-center justify-center gap-1.5"
              >
