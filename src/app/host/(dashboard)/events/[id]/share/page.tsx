    ...
    <div className="space-y-6">
      <div>
        <p className="text-sm text-muted-foreground">
          <a href="/host" className="hover:text-foreground transition-colors">Events</a>
          {" / "}
          <a href={`/host/events/${eventId}/questions`} className="hover:text-foreground transition-colors">{event.title}</a>
          {" / Share"}
        </p>
