-- Server-authoritative answer submission via RPC.
-- Runs as security definer so it can read correct_answer (bypasses RLS).
-- Called from the client via supabase.rpc('submit_answer', {...}).
